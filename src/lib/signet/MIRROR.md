...
Why a mirror and not a path dep: Sistrum's TypeScript side takes its
waters as mirrors (cosmic, cumdach, epagoge, sky all stand this way);
only the Rust waters cross as path crates.
